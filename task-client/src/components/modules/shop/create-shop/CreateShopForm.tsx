            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} value={field.value || ""}   onChange={(e) => field.onChange(e.target.value ? Number(e.target.value) : "")}
 />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        className="h-36"
                        {...field}
                        value={field.value ? field.value.join("\n") : ""} // Join array to display in textarea
                        onChange={(e) => {
                          // Split the input by newlines or commas to create an array
                          const services = e.target.value.split("\n").map((service) => service.trim()).filter(Boolean);
                          field.onChange(services); // Pass the array to the field
                        }}
                      />
                    </FormControl>
                    <FormMessage />
